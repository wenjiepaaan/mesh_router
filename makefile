...
# Cadence NCSIM simulations and other tools                               #
#                                                                         #
# To compile                                                              #
# ----------                                                              #
# %> make                                                                 #
...
# %> make syn                                                             #
#                                                                         #
# To use another TOP module name via command line, you can use            #
# -----------------------------                                           #
...
###########################################################################
#                                                                          
# Setup environment variables to point the Cadence install directories      
# and license files etc                                                      

# top level module
TOP = tb_clock
TOP_SYN = tb_syn
DESIGN_NAME = frequency_divider_by3
